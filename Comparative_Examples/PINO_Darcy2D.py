...
Physics-Informed Fourier Neural Operator example for Darcy 2D problem
...
from utils.fno_utils import count_params, LpLoss, train_pino_darcy
...
t1 = default_timer()
train_mse_log, train_l2_log, test_l2_log = train_pino_darcy(model, train_loader, test_loader, myLoss, optimizer,
