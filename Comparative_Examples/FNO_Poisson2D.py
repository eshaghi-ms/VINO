...
# -*- coding: utf-8 -*-
"""
Fourier Neural Operator example for Poisson 2D problem
...
plt.savefig('Input Function' + '.png', dpi=600)
plt.show()

# fig_font = "DejaVu Serif"
# plt.rcParams["font.family"] = fig_font
# colors = ['viridis', 'inferno', 'Greys', 'Purples', 'RdYlBu', 'bwr', 'hsv', 'gnuplot', 'jet']
# for color in colors:
#    plt.figure()
#    plt.contourf(x_test_plot, y_test_plot, x_input, levels=500, cmap=color)
#    plt.colorbar()
#    plt.gca().set_aspect('equal', adjustable='box')
#    plt.title('Input Function')
#    plt.show()
