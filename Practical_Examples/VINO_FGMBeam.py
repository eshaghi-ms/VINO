"""
Energy-based Physics-Informed Fourier Neural Operator for a 2D elasticity problem for an FGM beam with
...
from utils.fno_utils import VinoFGMLoss
...
model_data["learning_rate"] = 0.005  # 0.005  # 0.005  # 0.001
model_data["num_epoch"] = 1000  # 100
...
loss_fn = VinoFGMLoss(model, model_data, normalizers, d=1, p=1, size_average=False)
